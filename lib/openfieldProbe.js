...
// - /periods/{id} está documentado en la referencia oficial de Connect.
// - /activities/{id} y /activities/{id}/periods son las formas habituales de
//   exponer el recurso; hoy la app asume que no existen sin haberlo probado.
export const rutasSonda = ({ activityId, periodId }) => {
  ...
  if (periodId) {
    ...
    rutas.push({ clave: "periodo-get", metodo: "GET", ruta: periodo });
    rutas.push({ clave: "periodo-options", metodo: "OPTIONS", ruta: periodo });
  }
