...
export const planificarCortes = ({
  ...
  (Array.isArray(tareas) ? tareas : []).forEach((tarea) => {
    ...
    // de sus datos. Comprobado en 26-05 T: un corte que termina después de
    // ese fin vuelve con 422; el mismo corte terminando antes, se graba y se
    // grafica. Por eso acá es un freno, con la ventana para mostrarla en hora
    // local.
