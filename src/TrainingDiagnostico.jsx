...
// Pruebas técnicas de Ajustes: los paneles 03, 04, credenciales, A, B y C
// tal cual estaban, con sus endpoints, bodies y textos. Solo cambia el marco:
// cada panel es una tarjeta de Partido y la pantalla tiene su Volver.
export default function TrainingDiagnostico({ cuenta, onVolver }) {
    ...
    <div className="app">
      <div className="contenedor">
        <header className="encabezado">
          ...
          <p>Ajustes · Pruebas técnicas</p>
        </header>

        <div className="aviso-base espera">
          <div>
            <b>Son para revisar problemas</b>
            <p>Usalas solo si te lo piden por chat.</p>
          </div>
        </div>

        <section className="tarjeta tarjeta-ficha">
          <div className="cabeza-ficha">
            <b>Acceso al editor</b>
            <span>03</span>
          </div>
              ...
              {fallaPase && (
                <>
                  ...
                  <div className="entrenamiento-sonda-acciones">
                    <button type="button" className="boton-texto" onClick={copiarPase}>
          ...
          {pase && (
            <>
              ...
              {copiaPase === "error" && (
                <p className="error-equipo">No se pudo copiar automáticamente. Abrí el JSON completo y copialo a mano.</p>
              )}
            ...
            <>
              ...
              {fallaEscritura && (
                <>
                  ...
                  <div className="entrenamiento-sonda-acciones">
                    <button type="button" className="boton-texto" onClick={copiarEscritura}>
        ...
        <section className="tarjeta tarjeta-ficha">
          <div className="cabeza-ficha">
            <b>Credenciales para estas pruebas</b>
            <span>·</span>
          </div>
          <p className="pista-equipo">Solo las usan las pruebas de abajo. No se guardan.</p>
        ...
        <section className="tarjeta tarjeta-ficha">
          <div className="cabeza-ficha">
            <b>Prueba de login del editor</b>
            <span>A</span>
          </div>
          <p className="pista-equipo">Antes de habilitar cualquier escritura.</p>

          <button
            type="button"
            className="boton-secundario entrenamiento-ajustes-boton-ancho"
        ...
        <section className="tarjeta tarjeta-ficha">
          <div className="cabeza-ficha">
            <b>Inspección del Cloud Editor</b>
            <span>C</span>
          </div>
          <p className="pista-equipo">
